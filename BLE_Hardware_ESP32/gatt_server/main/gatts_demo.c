...
static void twai_transmit_task(void *arg)
{
    ...
    ESP_LOGI(GATTS_TAG, "Initial Values -  DC Current Limit: %d,\n Frequency: %d,\n",
                  DC_current_limit, frequency);
    ...
    while (1)
    {
        ...
        ESP_LOGI(GATTS_TAG, "Before Sending -  DC Current Limit: %d,\n Frequency: %d,\n",
                  DC_current_limit, frequency);
        ...
        twai_message_t transmit_message_switch = {
            ...
            .data = {0x35, 0x00, 0x00, DC_current_limit, 0x00, frequency_1, frequency_2, 0x00}};
        ...
        ESP_LOGI(GATTS_TAG, "After Sending - DC Current Limit: %d,\n Frequency: %d,\n",
                 DC_current_limit, frequency);
            ...
            if (param->write.len >= 7) {
                ...
                switch (~opcode) {
                    ...
                    case 0x0C: // Frequency
                        ...
                        break;
                    // case 0x0D: // Torque
                    //     ESP_LOGI(GATTS_TAG, "Message: Slop");
                    //     DC_current_limit = payload; // Torque
                    //     break;
