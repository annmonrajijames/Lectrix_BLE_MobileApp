...
#define TEST_DEVICE_NAME            "LECTRIX-Annmon" // CHANGE ESP32 hardware name here(name shown while scanning in mobile app), example change LECTRIX-Annmon to AnnmonRajiJames
