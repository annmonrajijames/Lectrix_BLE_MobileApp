...
type DataTransferProps = NativeStackScreenProps<RootStackParamList, 'HIL_Receive_from_vehicle'>;

const HIL_Receive_from_vehicle: React.FC<DataTransferProps> = ({ route }) => {
