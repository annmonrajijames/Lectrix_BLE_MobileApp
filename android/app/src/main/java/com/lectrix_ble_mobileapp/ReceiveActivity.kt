...
class ReceiveActivity : AppCompatActivity() {
    ...
    cbCluster_heartbeat, cbOdo_Cluster, cbSW_Version_MAJ, cbSW_Version_MIN, cbHW_Version_MAJ, cbHW_Version_MIN, cbIgnitionStatus, cbLoadDetection, 
    ...
    data class VehicleMetrics(
        ...
        val MCU_Fault_Code: Double?, val MCU_ID: Double?, val Cluster_heartbeat: Double?, val Odo_Cluster: Double?, val SW_Version_MAJ: Double?, val SW_Version_MIN: Double?, val HW_Version_MAJ: Double?, val HW_Version_MIN: Double?,
